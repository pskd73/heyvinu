...
#ifdef USE_ESP32
  state->channel_frequency_starts = heap_caps_malloc(num_channels_plus_1 * sizeof(*state->channel_frequency_starts), MALLOC_CAP_INTERNAL | MALLOC_CAP_8BIT);
...
#ifdef USE_ESP32
  state->channel_weight_starts = heap_caps_malloc(num_channels_plus_1 * sizeof(*state->channel_weight_starts), MALLOC_CAP_INTERNAL | MALLOC_CAP_8BIT);
...
#ifdef USE_ESP32
  state->channel_widths = heap_caps_malloc(num_channels_plus_1 * sizeof(*state->channel_widths), MALLOC_CAP_INTERNAL | MALLOC_CAP_8BIT);
...
#ifdef USE_ESP32
  state->work = heap_caps_malloc(num_channels_plus_1 * sizeof(*state->work), MALLOC_CAP_INTERNAL | MALLOC_CAP_8BIT);
  if (state->work == NULL)
#endif
  {
...
#ifdef USE_ESP32
  center_mel_freqs = heap_caps_malloc(num_channels_plus_1 * sizeof(*center_mel_freqs), MALLOC_CAP_INTERNAL | MALLOC_CAP_8BIT);
...
#ifdef USE_ESP32
  actual_channel_starts = heap_caps_malloc(num_channels_plus_1 * sizeof(*actual_channel_starts), MALLOC_CAP_INTERNAL | MALLOC_CAP_8BIT);
...
#ifdef USE_ESP32
  actual_channel_widths = heap_caps_malloc(num_channels_plus_1 * sizeof(*actual_channel_widths), MALLOC_CAP_INTERNAL | MALLOC_CAP_8BIT);
